...
const ParcoursPage = () => (
  <Layout>
    ...
    <p>
      <strong>Orthophoniste spécialisée en neurologie</strong>, je me suis tournée depuis plus de
      10 ans vers le <strong>travail émotionnel</strong>, car à tout âge, nous pouvons être sujet
      à des blocages émotionnels : ces conditionnements apparus parfois dès
      l’enfance qui déterminent malgré nous notre comportement et nous gâchent
      la vie.
      </p>
      <br />
      <p>
      ...
      émotionnels.
      Cette méthode thérapeutique permet de les effacer durablement. Elle est
      douce, efficace, et quelques séances peuvent remplacer des années de
      thérapie.
      </p>
      <br />
      <p>   
      ...
      <ul>
        ...
        <li>
          ...
          colère, énurésie, troubles de l’alimentation, allergies,
          hyperhydrose...
        </li>
